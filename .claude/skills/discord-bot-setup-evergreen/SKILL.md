...
Use `/read-config-evergreen` to get the `owner_name`.
...
7. Restart the bot and send a final test: `python3 scripts/discord_send.py "@<owner_name> Setup complete!" --channel <channel_id>` to confirm mentions work.
